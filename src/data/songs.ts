...
export const tutorials: Song[] = [
  {
    ...
    chords: [
      ...
      // All transcribed/imported recording for `allOfMe_001` has been removed per user request.
...
// User recordings, helper functions and post-processing removed per user request.
